...
<body>
    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a class="active" href="optimistregatta2019.html"><i class="fa fa-file"></i> Optimist Regatta 2019</a>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                ...
                <td>B</td>
                <td>BUL 421</td>
                <td>SC Cherno More - Briz Varna</td>
                <td>Kristiyan Strahilov</td>
                <td>(2)</td>
                <td>2</td>
                <td>1</td>
                <td>1</td>
            ...
            <tr>
                ...
                <td>BJ</td>
                <td>GRE 249</td>
                <td>Sailing club Greece</td>
                <td>Nicolaos Tsitiridis</td>
                <td>1</td>
                <td>(3)</td>
                <td>2</td>
                <td>2</td>
